...
public class FTPUtil {
    ...
    private static final String FTPIP=ProperitiesUtils.readByKey("ftp.server.ip");
    private static final String FTPUSER=ProperitiesUtils.readByKey("ftp.server.user");
    private static final String FTPPASSWORD=ProperitiesUtils.readByKey("ftp.server.password");
    ...
    public boolean connectFTPServer(String ftpIp,String ftpUser,String ftpPass){
