...
public class OrderServiceImpl implements IOrderService {
    ...
    public ServerResponse createOrder(Integer userId, Integer shippingId) {
        ...
        //2、根据userId查询购物车中已勾选的商品--->List<Cart>
    ...
    public ServerResponse get_order_cart_product(Integer userId) {
        ...
        cartOrderItemVO.setImageHost(ProperitiesUtils.readByKey("imageHost"));
        List<OrderItem> orderItemList= (List<OrderItem>) serverResponse.getData();
    ...
    public ServerResponse send(Long orderNo) {
        ...
        if (order.getStatus()==Const.OrderStatusEnum.ORDER_PAYED.getCode()){
            ...
            return ServerResponse.serverResponseBySuccess("订单已发货");
        }
    ...
    private OrderVO assembleOrderVO(Order order,List<OrderItem> orderItemList,Integer shippingId){
        ...
        orderVO.setImageHost(ProperitiesUtils.readByKey("imageHost"));
    ...
    public ServerResponse pay(Order order) throws IOException {
        ...
        AlipayTradePrecreateRequestBuilder builder = new AlipayTradePrecreateRequestBuilder()
                ...
                .setNotifyUrl("http://123.56.25.149:8080/Shopping_demo_1.1/order/alipay_callback.do")//支付宝服务器主动通知商户服务器里指定的页面http路径,根据需要设置
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                map.put("qrCode",ProperitiesUtils.readByKey("imageHost")+"/qr-"+response.getOutTradeNo()+".png");
